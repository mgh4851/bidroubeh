...
function bidroubeh_migrator_activate() {
    ...
    $data_file = __DIR__ . '/data/bidrubeh-content.json';
    if (!is_readable($data_file)) {
        wp_die('Bidroubeh migration data file is missing.');
    }
    ...
    try {
        ...
        bidroubeh_migrator_copy_tree(__DIR__ . '/uploads', $upload['basedir']);
